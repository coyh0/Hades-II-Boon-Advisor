...
- [x] Build and verify the Thunderstore package.
  - Final `tcli 0.2.4` build produced `Coyh0Mods-Hades_II_Boon_Advisor-0.1.1.zip` after the README documentation update.
  - Verified the packaged README contains the `Build profile selection` section and documents `BUILD_PROFILE = "auto"`.
  - SHA-256: `A0A1789275E72431FA788AFE37B6F642A107C6B9A660581F8D9876CB125422B8`.
