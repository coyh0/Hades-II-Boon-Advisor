...
foreach ($file in @('tools\Stage-Probe.ps1', 'tools\Generate-BoonAdvisorProfiles.ps1', 'src\main.lua', 'src\Logger.lua', 'src\Localization.lua', 'src\GameState.lua', 'src\OfferSnapshot.lua', 'src\ScoringEngine.lua', 'src\UI.lua', 'src\ProfileResolver.lua', 'data\builds\registry.lua', 'data\builds\sister_blades_melinoe_intermediate.lua', 'data\builds\sister_blades_melinoe_starter.lua', 'data\builds\sister_blades_morrigan_meta.lua', 'data\builds\black_coat_melinoe_intermediate.lua', 'data\canonical\profiles\sister_blades_melinoe_intermediate.json', 'data\canonical\profiles\sister_blades_melinoe_starter.json', 'data\canonical\profiles\sister_blades_morrigan_meta.json', 'data\canonical\profiles\black_coat_melinoe_intermediate.json', 'data\canonical\mechanics\sister_blades_melinoe.json', 'data\canonical\mechanics\sister_blades_morrigan.json', 'data\canonical\mechanics\black_coat_melinoe.json', 'config\settings.lua', 'manifest.json')) {
...
Write-Output 'PASS: staging rebuilt twice; stale files removed; exactly 15 expected files; hashes match; sibling dist directory preserved'
