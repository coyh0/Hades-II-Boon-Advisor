...
- [ ] **11C.8 — Fix Ares base-branch scoring and rerun realistic live DEV validation.**
  ...
  - [ ] Independently review the five-file local diff and reconcile Codex's local `3201282` base with newer GitHub documentation commits before any authorized commit/push.
