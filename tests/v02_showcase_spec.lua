-- Approved five-row v0.2 projection: runtime behavior and conservative fallbacks.
local root = "."
...
print("PASS: v0.2 showcase Hammer ranks, alternatives, replacements and unconditional Ares")
